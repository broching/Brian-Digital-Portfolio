...
function Homepage() {
    ...
    return (
        <>
            <Hero profile={profilePic} />
            <AboutMeSegment />
            <SkillSegment skillList={skillList} />
            <ExperienceSegment skillList={skillList} />
            <ProjectSegment skillList={skillList} />
            <AchievementSegment skillList={skillList} />
            <CcaSegment skillList={skillList} />
            <ScrollToTopButton />
        </>
    );
}
